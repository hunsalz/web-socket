...
class Github {
    ...
    getTag(tag) {
        return __awaiter(this, void 0, void 0, function* () {
            const ref = yield this._github.gitdata.getReference({ owner: this._owner, repo: this._repo, ref: `tags/${tag}` });
            return {
                name: tag,
                tarball_url: `https://codeload.github.com/${this._owner}/${this._repo}/legacy.tar.gz/${ref.object.sha}`
            };
        });
    }
}
