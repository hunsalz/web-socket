...
suite('Es6 Module Bundling', () => {
    ...
    suite('rewriting export specifiers', () => {
      ...
      `
        ...
        test('export specifier is not in a bundle', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const { documents } = yield bundler.bundle(yield bundler.generateManifest([aUrl, dUrl]));
            chai_1.assert.deepEqual(documents.get(aUrl).content, test_utils_1.heredoc `
        import { b } from './b.js';
        export { b } from './b.js';
        var a = {
    ...
    suite('dynamic imports', () => {
      ...
      `);
        ...
        test('deduplicate static imports, not dynamic', () => __awaiter(this, void 0, void 0, function* () {
            const analyzer = test_utils_1.inMemoryAnalyzer({
                'app.js': `
        ...
        `,
            ...
            const bundler = new bundler_1.Bundler({ analyzer, strategy: bundle_manifest_1.generateShellMergeStrategy(appUrl) });
            const manifest = yield bundler.generateManifest([appUrl]);
            chai_1.assert.deepEqual([...manifest.bundles.keys()], [com2Url, appUrl]);
            const { documents } = yield bundler.bundle(manifest);
            chai_1.assert.deepEqual(documents.get(appUrl).content, test_utils_1.heredoc `
